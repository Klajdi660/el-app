...
import { appiKey } from "../config/config";
...
export const MovieProvider = ({ children }) => {
  ...
  const fetchSearch = async (query) => {
    const data = await fetch(
      `https://api.themoviedb.org/3/search/movie?api_key=${appiKey}&language=en-US&query=${query}&page=1&include_adult=false`
    );
    const movies = await data.json();
    setMovies(movies.results);
    setFiltered(movies.results);
  ...
  const fetchNowPlaying = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/now_playing?api_key=${appiKey}&language=en-US&page=1`
    );
    const movies = await data.json();
    setMovies(movies.results);
    setFiltered(movies.results);
  ...
  const fetchTopRated = async () => {
    const data = await fetch(
      ...
      `https://api.themoviedb.org/3/movie/top_rated?api_key=${appiKey}&language=en-US&page=1`
    );
    const movies = await data.json();
    setMovies(movies.results);
    setFiltered(movies.results);
  ...
  const fetchUncoming = async () => {
    const data = await fetch(
      `https://api.themoviedb.org/3/movie/upcoming?api_key=${appiKey}&language=en-US&page=1`
    );
    const movies = await data.json();
    setMovies(movies.results);
    setFiltered(movies.results);
